...
Learn how to integrate Filan Admin Template with backend APIs and external services
{: .fs-6 .fw-300 }
...
class RealTimeDashboard {
  ...
  showNotification(data) {
    ...
    if (window.FilanPlugins && window.FilanPlugins.getPlugin('notifications')) {
      const notifications = window.FilanPlugins.getPlugin('notifications');
