...
Learn how to customize and extend Filan Admin Template to match your brand and requirements
{: .fs-6 .fw-300 }
...
window.FilanPlugins = new PluginSystem();
```
...
// Register plugin
window.FilanPlugins.registerPlugin('notifications', NotificationPlugin);
```
